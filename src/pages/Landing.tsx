        ...
        <div className="container">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-primary/30 mb-8 animate-bounce-subtle"
            >
            ...
            <motion.p 
              ...
              className="text-xl text-muted-foreground mb-10 max-w-xl mx-auto text-balance"
            >
      ...
      <section className="py-20 px-4">
        <div className="container">
          ...
          >
            ...
            <div className="relative glass rounded-3xl p-12 border border-primary/20 hover:border-primary/40 transition-all duration-500">
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
      ...
      <footer className="py-8 px-4 border-t border-border/50">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-muted-foreground">
            <a href="#" className="hover:text-foreground transition-colors duration-300 hover:-translate-y-0.5">Terms</a>
            <a href="#" className="hover:text-foreground transition-colors duration-300 hover:-translate-y-0.5">Privacy</a>
            <a href="#" className="hover:text-foreground transition-colors duration-300 hover:-translate-y-0.5">About</a>
          </div>
